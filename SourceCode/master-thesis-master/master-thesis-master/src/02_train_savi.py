...
class Trainer(BaseTrainer):
    ...
    def visualizations(self, batch_data, epoch, iter_):
        ...
        videos, targets, initializer_kwargs = self.unwrap_batch_data(batch_data)
        ...
        savepath = os.path.join(self.plots_path, f"objs_epoch_{epoch}_iter_{iter_}.png")
        savepath = None
        _ = visualize_decomp(
        ...
        savepath = os.path.join(self.plots_path, f"maskedObj_epoch_{epoch}_iter_{iter_}.png")
        savepath = None
