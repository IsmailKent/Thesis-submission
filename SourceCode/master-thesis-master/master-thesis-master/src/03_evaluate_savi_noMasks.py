...
Since we do not have masks to compare with, we simply evaluate based on the
qualitiy of the reconstructed images using videp-prediction metrics
"""
...
class Evaluator(BaseEvaluator):
    """
    Class for evaluating a SAVI model checkpoint on a dataset without ground truth masks.
    Since we do not have masks to compare with, we simply evaluate based on the
    qualitiy of the reconstructed images using videp-prediction metrics
    """
...
if __name__ == "__main__":
    ...
    logger.log_info("Starting frame reconstruction evaluation procedure", message_type="new_exp")
