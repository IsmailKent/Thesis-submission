"""
Base evaluator from which all evaluator modules inherit.
...
class BaseEvaluator:
    ...
    def __init__(self, exp_path, checkpoint, exact_slots=True):
        """
        ...
        self.results_name = f"{model_name}_ExactSlots_{exact_slots}"
