...
class BaseFigGenerator:
    ...
    sa_model_directory: string/None
        Name of a SA or SAVI model checkpoint to evaluate.
    ...
    def load_model(self, exp_path=None):
        """
        Setup model and loading pretrained paramters
        ...
        checkpoint_path = os.path.join(exp_path, "models", self.sa_model_directory)
